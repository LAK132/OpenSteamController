...
fn map_controller_input(input: ControllerInput) -> uinput::event::Controller {
    ...
    match input {
        ...
        ControllerInput::TL => Controller::GamePad(controller::GamePad::TL),
        ControllerInput::TR => Controller::GamePad(controller::GamePad::TR),
        ControllerInput::TL2 => Controller::GamePad(controller::GamePad::TL2),
        ControllerInput::TR2 => Controller::GamePad(controller::GamePad::TR2),
        ...
        ControllerInput::ThumbL => Controller::GamePad(controller::GamePad::ThumbL),
        ControllerInput::ThumbR => Controller::GamePad(controller::GamePad::ThumbR),
